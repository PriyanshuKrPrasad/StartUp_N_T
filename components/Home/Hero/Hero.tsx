    ...
    <div className="relative w-full h-[110vh] sm:h-screen bg-[url('/images/bg.png')] bg-cover bg-center flex justify-center flex-col">
      <div className="w-[90%] md:w-[80%] mx-auto items-center grid grid-cols-1 xl:grid-cols-2 gap-10">
        ...
        <div data-aos="fade-up">
          <p className="text-sm sm:text-xl md:text-xl font-bold text-blue-950">
            Make the Smartest Investment
          </p>
          <h1
            className="text-2xl md:text-3xl lg:text-4xl mt-6 mb-6 font-bold text-blue-950 leading-[2.5rem]
                md:leading-[3.5rem]"
          >
            Kickstart, Scale, & Thrive Faster with{" "}
            <span className="text-rose-700">TechDev</span>{" "}
          </h1>
          <p className="text-sx sm:text-sm md:text-base font-medium text-gray-700">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minus
            inventore consectetur neque, illum voluptates voluptatem veniam
            similique error, velit sapiente fugiat, \eius laudantium
            necessitatibus? Sit, molestias alias? Corrupti praesentium sequi
            voluptas, illo quisquam vitae tempora?
          </p>
          {/* {Rating} */}
          ...
          >
            ...
            <a
              href="#_"
              className="relative px-10 py-3 font-medium text-white transition duration-300 bg-green-500 rounded-md hover:bg-green-600 ease"
            >
              <span className="absolute bottom-0 left-0 h-full -ml-2">
                <svg
                  viewBox="0 0 487 487"
