...
const ClientReviewCard = ({ image , name, rating }: Props) => {
  return <div className="bg-white shadow-md p-8 sm:flex items-center 
    ...
    >
      ...
      <div>
        ...
        <p className="mt-2 text-blue text-gray-700 font-medium">
            Lorem ipsum dolor sit amet 
            consectetur adipisicing elit. Nostrum, quae!
            Lorem ipsum dolor sit amet.
        </p>
      </div>
    </div>
